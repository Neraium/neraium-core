...
export const COOLING_DEMO_SCENARIOS = [
  {
    ...
    durationMs: 30000,
    narrative: 'Datacenter cooling operating at design efficiency - all systems nominal',
  },
  {
    name: 'CRAC-Unit-North-01 (Early Drift - Phase 1)',
    state: COOLING_EARLY_DRIFT,
    durationMs: 30000,
    narrative: 'Cooling efficiency beginning to degrade - subtle mechanical wear detected',
  },
  {
    name: 'CRAC-Unit-North-01 (Structural Shift - Phase 1)',
    state: COOLING_STRUCTURAL_SHIFT,
    durationMs: 30000,
    narrative: 'Structural relationships weakening - correlation breakdown emerging',
  },
  {
    name: 'CRAC-Unit-North-01 (Pre-instability)',
    state: COOLING_PRE_INSTABILITY,
    durationMs: 30000,
    narrative: 'System approaching failure conditions - immediate action required before thermal runaway',
  },
]
