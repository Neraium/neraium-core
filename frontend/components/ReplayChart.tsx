      ...
      <div ref={scrollRef} className="chart-scroll-container">
        <div className="chart-container" style={{ minWidth: `${W}px` }}>
          ...
          >
            ...
            {currentDriftPoint && (
              <g>
                <circle cx={(typeof ((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) == "number" && !Number.isNaN((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) ? (typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0) : 0)} cy={(typeof ((typeof (currentDriftPoint.y ?? 0) === "number" && !Number.isNaN(currentDriftPoint.y ?? 0) ? currentDriftPoint.y ?? 0 : 0)) == "number" && !Number.isNaN((typeof (currentDriftPoint.y ?? 0) === "number" && !Number.isNaN(currentDriftPoint.y ?? 0) ? currentDriftPoint.y ?? 0 : 0)) ? (typeof (currentDriftPoint.y ?? 0) === "number" && !Number.isNaN(currentDriftPoint.y ?? 0) ? currentDriftPoint.y ?? 0 : 0) : 0)} r="8" fill="none" stroke="#FFFFFF" strokeWidth="2.2" opacity="0.4" />
                <circle cx={(typeof ((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) == "number" && !Number.isNaN((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) ? (typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0) : 0)} cy={(typeof ((typeof (currentDriftPoint.y ?? 0) === "number" && !Number.isNaN(currentDriftPoint.y ?? 0) ? currentDriftPoint.y ?? 0 : 0)) == "number" && !Number.isNaN((typeof (currentDriftPoint.y ?? 0) === "number" && !Number.isNaN(currentDriftPoint.y ?? 0) ? currentDriftPoint.y ?? 0 : 0)) ? (typeof (currentDriftPoint.y ?? 0) === "number" && !Number.isNaN(currentDriftPoint.y ?? 0) ? currentDriftPoint.y ?? 0 : 0) : 0)} r="5.5" fill="#FFFFFF" stroke="#60A5FA" strokeWidth="1.8" opacity="1" filter="url(#brightGlow)" />
              </g>
            )}
            {currentInstabilityPoint && (
              <g>
                <circle cx={(typeof ((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) == "number" && !Number.isNaN((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) ? (typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0) : 0)} cy={(typeof ((typeof (currentInstabilityPoint.y ?? 0) === "number" && !Number.isNaN(currentInstabilityPoint.y ?? 0) ? currentInstabilityPoint.y ?? 0 : 0)) == "number" && !Number.isNaN((typeof (currentInstabilityPoint.y ?? 0) === "number" && !Number.isNaN(currentInstabilityPoint.y ?? 0) ? currentInstabilityPoint.y ?? 0 : 0)) ? (typeof (currentInstabilityPoint.y ?? 0) === "number" && !Number.isNaN(currentInstabilityPoint.y ?? 0) ? currentInstabilityPoint.y ?? 0 : 0) : 0)} r="8" fill="none" stroke="#FFFFFF" strokeWidth="2.2" opacity="0.4" />
                <circle cx={(typeof ((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) == "number" && !Number.isNaN((typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0)) ? (typeof (currentX) === "number" && !Number.isNaN(currentX) ? currentX : 0) : 0)} cy={(typeof ((typeof (currentInstabilityPoint.y ?? 0) === "number" && !Number.isNaN(currentInstabilityPoint.y ?? 0) ? currentInstabilityPoint.y ?? 0 : 0)) == "number" && !Number.isNaN((typeof (currentInstabilityPoint.y ?? 0) === "number" && !Number.isNaN(currentInstabilityPoint.y ?? 0) ? currentInstabilityPoint.y ?? 0 : 0)) ? (typeof (currentInstabilityPoint.y ?? 0) === "number" && !Number.isNaN(currentInstabilityPoint.y ?? 0) ? currentInstabilityPoint.y ?? 0 : 0) : 0)} r="5.5" fill="#FFFFFF" stroke="#FF8A5C" strokeWidth="1.8" opacity="1" filter="url(#brightGlow)" />
              </g>
            )}
